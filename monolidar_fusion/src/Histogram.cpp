...
void Histogram::AddElement(double value) {
    ...
    //        std::cout << std::runtime_error("Histogram: binWidth==0.");
    //    }
    //    if (_bins.size() == 0) {
    //        std::cout << "Histogram error: bins size=0" << std::endl;
    //        std::cout << std::runtime_error("Histogram error: bins size=0");
    //    }
...
std::vector<double>& Histogram::getElements(int binIndex) {
    ...
    //        std::cout << std::runtime_error("Histogram error: wrong indexing");
    //    }
